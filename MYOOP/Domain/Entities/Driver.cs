...
namespace OOP.Domain.Entities
{
    ...
    public class Driver : User
    {
        ...
        [IgnoreDataMember]
        public decimal AverageRating => ratingCount == 0 ? 5.0m : Math.Round(ratingTotal / ratingCount, 2);
        protected Driver() { }
        public Driver(
             Guid id,
             string name,
        ...
        // FIX: Đổi tham số từ double sang int để nhất quán với Rating.Score (int)
